...
client$navigate("https://hodnoceni.ff.cuni.cz/results/evaluation/winter-term-20212022/department")
...
write_rds(courses_complete, "data-input/courses-2021-2022-winter.rds")
