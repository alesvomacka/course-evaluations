...
client$navigate("https://evaluace.ff.cuni.cz/results/evaluation/winter-term-20222023/department")
...
write_rds(courses_complete, "data-input/courses-2022-2023-winter.rds")
